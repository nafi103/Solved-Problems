...
void solve()
{
    ...
    while(mp['0'].size()<k){
        int mn = INT_MAX;
        if(mp['1'].size()>k) mn = mp['1'].front();
        if(mp['2'].size()>k) mn = min(mn,mp['2'].front());
        str[mn] = '0';
        if(mp['1'].size() and mp['1'].front()==mn) mp['1'].pop_front();
        else mp['2'].pop_front();
        mp['0'].push_back(mn);
    }
    while(mp['2'].size()<k){
        if(mp['0'].size()>k){
            mp['2'].push_back(mp['0'].back());
            str[mp['0'].back()]  = '2';
            mp['0'].pop_back();
        }else{
            mp['2'].push_back(mp['1'].back());
            str[mp['1'].back()] = '2';
            mp['1'].pop_back();
        }
    }
    while(mp['1'].size()<k){
        if(mp['0'].size()>k){
            mp['1'].push_back(mp['0'].back());
            str[mp['0'].back()] = '1';
            mp['0'].pop_back();
        }else{
            mp['1'].push_back(mp['2'].front());
            str[mp['2'].front()] = '1';
            mp['2'].pop_front();
        }
    }
