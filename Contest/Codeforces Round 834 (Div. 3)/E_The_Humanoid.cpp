...
int getRandomNumber(int l, int r) {return uniform_int_distribution<int>(l, r)(rng);} 
 /****************************************************************/
 int f(int i, int power, int green, int blue, vi &v,int &n){
    if(i==n or (power<v[i] and green==0 and blue==0)){
        return i;
    }
    if(power>v[i]) return f(i+1,power+v[i]/2,green,blue,v,n);
    return max((green?f(i,power*2,green-1,blue,v,n):i),(blue?f(i,power*3,green,blue-1,v,n):i));
}
 void solve()
{
    int n,power;
