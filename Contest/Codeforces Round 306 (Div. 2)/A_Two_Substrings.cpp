 ...
 void solve()
{
    string str;
    cin>>str;
    size_t firstAB = str.find("AB"), firstBA = str.find("BA");
    if(firstAB==string::npos or firstBA==string::npos){
        no;
        return;
    } 
    size_t BA = str.find("BA",firstAB+2), AB = str.find("AB",firstBA+2);
    if(AB!=string::npos or BA!=string::npos){
        yes;
    }else no;
}
 int32_t main()
